package templete_scoreboard_pkg;
   ...
   class templete_scoreboard extends uvm_scoreboard;
      ...
      task run_phase(uvm_phase phase);
        ...
        forever begin
            // Block until both Actual and Expected are received
