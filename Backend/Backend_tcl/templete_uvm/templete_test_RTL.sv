...
class templete_test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if(!uvm_config_db #(virtual templete_interface)::get(this,"","templete_REF_interface" , cfg.REF_virtual_interface))
      `uvm_fatal("build_phase", "Test - unable to get the templete REF virtual interface from config");
