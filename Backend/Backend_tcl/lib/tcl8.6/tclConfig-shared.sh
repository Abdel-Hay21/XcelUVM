...
TCL_LIBS='netapi32.lib kernel32.lib user32.lib advapi32.lib ws2_32.lib bufferoverflowU.lib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/Administrator/dbn/lba/GlobalBuildArena/builds/win32-x64/tcl/win/win32-x64 -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/Tcl/lib -ltcl86'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/Administrator/dbn/lba/GlobalBuildArena/builds/win32-x64/tcl/win/win32-x64 -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Tcl/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/Administrator/dbn/lba/GlobalBuildArena/builds/win32-x64/tcl/win/win32-x64/tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/Tcl/lib/tclstub86.lib'
