...
#
# ActiveState ActiveTcl 8.6.4.1.299124 Win32/x64, Mon Jun 08 10:11:23 PDT 2015
#
...
namespace eval ::activestate {
	...
	product       {ActiveTcl}
	release       {8.6.4.1}
	tcl,revision  {ef02e1dfd92a04054f9ae123fe7e498f793963ff}
	tk,revision   {9e919f756da587aae977c2edfcc5003004c90a78}
	maturity      {final}
	arch          {win32-x64}
	buildtime,sec {1433783483}
	buildtime,fmt {Mon Jun 08 10:11:23 PDT 2015}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.4.1.299124 Win32/x64 @ Mon Jun 08 10:11:23 PDT 2015 ef02e1dfd92a04054f9ae123fe7e498f793963ff / normal}
    }
}

package provide {ActiveTcl} {8.6.4.1.299124}
