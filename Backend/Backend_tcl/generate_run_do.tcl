...
puts $fp "# QuestaSim compilation & execution script"
puts $fp "vlib work\nvmap work work\n"
...
if {$gm_type eq "RTL" || $single_agent} {
    puts $fp "vlog -work work ../verif/interface/${project_name}_interface.sv"
} else {
...
if {$gm_type eq "SB"} {
    puts $fp "vlog -work work ../verif/environment/${project_name}_predictor.sv"
}
puts $fp "vlog -work work ../verif/environment/${project_name}_virtual_sequencer.sv"
puts $fp "vlog -work work ../verif/environment/${project_name}_environment.sv"
puts $fp "vlog -work work ../verif/sequences/sequences/*.sv"
puts $fp "vlog -work work ../verif/sequences/virtual/${project_name}_virtual_sequence.sv"
...
if {$a_flag} {
    ...
    puts $fp "vlog -work work ../verif/assertions/${project_name}_bind.sv"
}
puts $fp ""

puts $fp "# 4. Compile Top Module"
puts $fp "vlog -work work ../verif/top/${project_name}_top.sv\n"

puts $fp "# 5. Run Simulation"

if {$a_flag} {
    puts $fp "vsim -voptargs=+acc work.${project_name}_top work.${project_name}_bind_sv_unit -ldflags \"-lws2_32\""
} else {
    puts $fp "vsim -voptargs=+acc work.${project_name}_top -ldflags \"-lws2_32\""
}
